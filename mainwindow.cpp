...
void MainWindow::createDesign()
{
    ...
    p_button_percent->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    p_button_plus_minus->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    ...
    p_central_layout->addWidget(p_button_plus_minus, 1, 1, 1, 1);
    p_central_layout->addWidget(p_button_percent, 1, 2, 1, 1);
...
//    p_screen->setPlaceholderText("sample text");
    ...
    p_button_percent = new QPushButton("%");
    p_button_plus_minus = new QPushButton("+/-");
}
...
void MainWindow::createConnections()
{
    ...
    connect(p_button_percent, SIGNAL(clicked(bool)), this, SLOT(percentButtonPressed()), Qt::UniqueConnection);
    connect(p_button_plus_minus, SIGNAL(clicked(bool)), this, SLOT(plusMinusButtonPressed()), Qt::UniqueConnection);
...
void MainWindow::percentButtonPressed()
{
    p_screen->setText(QString::number(p_screen->text().toDouble() / 100.0));
}

void MainWindow::plusMinusButtonPressed()
{
    p_screen->setText(QString::number(p_screen->text().toDouble() * -1.0));
}
